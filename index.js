...
document
    .querySelectorAll(".coursework")[0]
    .addEventListener("click", function () {
        alert(
            "Relevant Coursework: Foundations of Programming Languages, Parallel Computing, Data Mining, Advanced Operating Systems, Mobile Application Development, Algorithms, Software Engineering, for AI."
        );
    });

document
    .querySelectorAll(".coursework")[1]
    .addEventListener("click", function () {
        alert(
...
document
    .querySelectorAll(".coursework")[2]
    .addEventListener("click", function () {
        alert(
            "Relevant Coursework: Programming in C++, Data Structures and Algorithms, System Programming, Fundamentals of Operating Systems, Database Management System, Advanced Network, Administration, Data Warehousing, Software Design."
        );
    });
...
function darkMode() {
    ...
    if (document.firstElementChild.getAttribute("data-bs-theme") === "dark") {
        ...
        document.querySelector("#proj1").addEventListener("mouseover", function () {
            document.querySelector("#proj1").classList.remove("tile-shad-dark");
            document.querySelector("#proj1").classList.add("tile-shad");
        });
        document.querySelector("#proj1").addEventListener("mouseout", function () {
            document.querySelector("#proj1").classList.remove("tile-shad");
        });

        document.querySelector("#proj2").addEventListener("mouseover", function () {
            document.querySelector("#proj2").classList.remove("tile-shad-dark");
            document.querySelector("#proj2").classList.add("tile-shad");
        });
        document.querySelector("#proj2").addEventListener("mouseout", function () {
            document.querySelector("#proj2").classList.remove("tile-shad");
        });

        document.querySelector("#proj3").addEventListener("mouseover", function () {
            document.querySelector("#proj3").classList.remove("tile-shad-dark");
            document.querySelector("#proj3").classList.add("tile-shad");
        });
        document.querySelector("#proj3").addEventListener("mouseout", function () {
            document.querySelector("#proj3").classList.remove("tile-shad");
        });
        ...
        document.querySelector("#proj1").addEventListener("mouseover", function () {
            document.querySelector("#proj1").classList.add("tile-shad-dark");
        });
        ...
        document.querySelector("#proj2").addEventListener("mouseover", function () {
        document.querySelector("#proj2").classList.add("tile-shad-dark");
    });
    ...
    document.querySelector("#proj3").addEventListener("mouseover", function () {
        document.querySelector("#proj3").classList.add("tile-shad-dark");
    });
